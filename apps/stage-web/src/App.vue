...
import { useMemoryContextStore } from '@proj-airi/stage-ui/stores/mods/api/memory-context'
...
const memoryContextStore = useMemoryContextStore()
const i18n = useI18n()
...
onMounted(async () => {
  ...
  await memoryContextStore.initialize()
